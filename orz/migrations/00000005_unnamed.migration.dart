...
class Migration5 extends Migration { 
  ...
  Future upgrade() async {
		...
		database.addColumn("_QuestionType", SchemaColumn.relationship("question", ManagedPropertyType.bigInteger, relatedTableName: "_Question", relatedColumnName: "qid", rule: DeleteRule.nullify, isNullable: true, isUnique: false));
		...
		database.addColumn("_UserFinish", SchemaColumn.relationship("user", ManagedPropertyType.bigInteger, relatedTableName: "_Blocklyuser", relatedColumnName: "uid", rule: DeleteRule.nullify, isNullable: true, isUnique: false));
		database.addColumn("_UserFinish", SchemaColumn.relationship("question", ManagedPropertyType.bigInteger, relatedTableName: "_Question", relatedColumnName: "qid", rule: DeleteRule.nullify, isNullable: true, isUnique: false));
		database.addColumn("_UserStore", SchemaColumn.relationship("user", ManagedPropertyType.bigInteger, relatedTableName: "_Blocklyuser", relatedColumnName: "uid", rule: DeleteRule.nullify, isNullable: true, isUnique: false));
		database.addColumn("_UserStore", SchemaColumn.relationship("question", ManagedPropertyType.bigInteger, relatedTableName: "_Question", relatedColumnName: "qid", rule: DeleteRule.nullify, isNullable: true, isUnique: false));
  }
